...
import android.server.search.SearchEngineManagerService;
...
class ServerThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            telephonyRegistry2 =  new TelephonyRegistry(context,true);
...
///LEWA BEGIN
            ...
            try {
                Slog.i(TAG, "IconManager Service");
                ServiceManager.addService(
                        "iconmanager", new com.lewa.server.IconManagerService(context) );
            } catch (Throwable e) {
                Slog.e(TAG, "Failure starting IconManager Service", e);
            }
///LEWA END
        }
