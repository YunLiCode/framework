...
public class Tethering extends INetworkManagementEventObserver.Stub {
    ...
    private String[] mUsbInternetDnsServers = {"192.168.0.1", "168.95.1.1"};
    ...
    private void updateTetheredNotification() {
        synchronized (Tethering.this.mNotificationSync) {
              ...
              Resources r = Resources.getSystem();
              CharSequence title = r.getText(com.android.internal.R.string.tethered_notification_title);
              String message = r.getString(com.mediatek.internal.R.string.tethered_notification_message_for_hotspot, connected, blocked);
    ...
    private void broadcastDataConnectionStateChanged(int state) {
        ...
        if (!mUsbInternetEnable && state == USB_INTERNET_CONNECTED) {
            ...
            */  
            ...
            try{
                InetAddress gwAddr = InetAddress.parseNumericAddress("192.168.0.100");
