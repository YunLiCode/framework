...
///LEWA BEGIN
        if(!lewa.content.PermissionHelper.checkPermission(sContext, android.os.Process.myPid(), android.os.Process.myUid(), lewa.content.PermissionHelper.PERMISSION_READ_SUBSCRIBER_ID))
            return null;
///LEWA END
        //MTK-START [mtk04070][111116][ALPS00093395]Support Gemini
    	if(mtkGeminiSupport){
...
///LEWA END
    ...
    @Deprecated	public String getNetworkOperatorNameGemini(int simId) {
        return (simId == PhoneConstants.GEMINI_SIM_1)
