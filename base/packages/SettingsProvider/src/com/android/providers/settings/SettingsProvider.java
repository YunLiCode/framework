...
public class SettingsProvider extends ContentProvider {
    ...
    // M: fix JE ,when delete an added user in tablet to notify more, ALPS00445619 {@
    private static final int NULL_USER_HANDLE = -1;
    // @}
    ...
    private void fullyPopulateCaches(final int userHandle) {
         // M: fix JE ,when delete an added user in tablet to notify more, ALPS00445619 {@
         if (userHandle == NULL_USER_HANDLE || mOpenHelpers.get(userHandle) == null) {
             Log.d(TAG, "userHandle  " + userHandle + "dbHelper "
                      + mOpenHelpers.get(userHandle));
         return;
        }
         // @}
