...
import com.android.providers.settings.ext.DefaultDatabaseHelperExt;
import com.android.providers.settings.ext.IDatabaseHelperExt;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// @}
///LEWA BEGIN
            // Woody Guo lewa @ 2012/10/22: Set default date format
...
///LEWA END
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSecure35Settings(stmt);
///lewa begin
            loadSetting(stmt, Settings.Secure.LEWALOCKSCREEN_INUSE,"1");
///lewa end
