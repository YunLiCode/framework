...
public class SignalClusterViewGemini extends LinearLayout implements NetworkControllerGemini.SignalCluster {
    ...
    protected void onAttachedToWindow() {
        ...
        int resId = PluginFactory.getStatusBarPlugin(mContext).getSignalIndicatorIconGemini(PhoneConstants.GEMINI_SIM_1);
        if (resId != -1) {
        ...
        int resIdGemini = PluginFactory.getStatusBarPlugin(mContext).getSignalIndicatorIconGemini(PhoneConstants.GEMINI_SIM_2);
        if (resIdGemini != -1) {
    ...
    public void apply() {
        ...
        if (mMobileVisible) {
            ...
            int state = SIMHelper.getSimIndicatorStateGemini(PhoneConstants.GEMINI_SIM_1);
            if (isSimInserted(PhoneConstants.GEMINI_SIM_1)
                ...
                int simColorId = SIMHelper.getSIMColorIdBySlot(mContext, PhoneConstants.GEMINI_SIM_1);
            ...
            if (mMobileStrengthId[0].getIconId() == PluginFactory.getStatusBarPlugin(mContext)
                    .getSignalStrengthNullIconGemini(PhoneConstants.GEMINI_SIM_1)) {
            ...
            int resId = PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthSearchingIconGemini(PhoneConstants.GEMINI_SIM_1);
        ...
        if (mMobileVisibleGemini) {
            ...
            int state = SIMHelper.getSimIndicatorStateGemini(PhoneConstants.GEMINI_SIM_2);
            if (isSimInserted(PhoneConstants.GEMINI_SIM_2)
                    && PhoneConstants.SIM_INDICATOR_LOCKED != state 
                    && PhoneConstants.SIM_INDICATOR_SEARCHING != state 
                    && PhoneConstants.SIM_INDICATOR_INVALID != state 
                    && PhoneConstants.SIM_INDICATOR_RADIOOFF != state) {
                int simColorId = SIMHelper.getSIMColorIdBySlot(mContext, PhoneConstants.GEMINI_SIM_2);
            ...
            if (mMobileStrengthIdGemini[0].getIconId() == PluginFactory.getStatusBarPlugin(mContext)
                    .getSignalStrengthNullIconGemini(PhoneConstants.GEMINI_SIM_2)) {
            ...
            /// M: When searching hide the data type icon
            int resId = PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthSearchingIconGemini(PhoneConstants.GEMINI_SIM_2);
