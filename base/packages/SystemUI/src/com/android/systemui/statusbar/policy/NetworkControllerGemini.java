...
public class NetworkControllerGemini extends BroadcastReceiver {
    ...
    public NetworkControllerGemini(Context context) {
        ...
        if (mSimCardReady) {
            int resId = PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthNullIconGemini(PhoneConstants.GEMINI_SIM_1);
            if (resId != -1) {
            ...
            int resIdGemini = PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthNullIconGemini(PhoneConstants.GEMINI_SIM_2);
            if (resIdGemini != -1) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(WifiManager.RSSI_CHANGED_ACTION)
            ...
            if (type == 1) {
                ...
                updateDataNetType(PhoneConstants.GEMINI_SIM_2);
                updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_1);
                updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_2);
                updateOperatorInfo();
            }
            refreshViews();
    ...
    PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onSignalStrengthsChanged(SignalStrength signalStrength) {
            ...
            updateDataNetType(PhoneConstants.GEMINI_SIM_1);
            updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_1);
            refreshViews(PhoneConstants.GEMINI_SIM_1);
        ...
        public void onServiceStateChanged(ServiceState state) {
            ...
            mDataNetType = telephonyManager.getNetworkTypeGemini(PhoneConstants.GEMINI_SIM_1);
            Xlog.d(TAG, "PhoneStateListener:onServiceStateChanged sim1 mDataNetType= " + mDataNetType);
            //END [20120301][ALPS00245624]
            updateDataNetType(PhoneConstants.GEMINI_SIM_1);
            updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_1);
            updateDataIcon(PhoneConstants.GEMINI_SIM_1);
            refreshViews(PhoneConstants.GEMINI_SIM_1);
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (isCdma(PhoneConstants.GEMINI_SIM_1)) {
                updateDataNetType(PhoneConstants.GEMINI_SIM_1);
                updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_1);
                refreshViews(PhoneConstants.GEMINI_SIM_1);
            }
            if (FeatureOption.MTK_DT_SUPPORT) {
                ...
                updateDataIcon(PhoneConstants.GEMINI_SIM_1);
                updateDataNetType(PhoneConstants.GEMINI_SIM_2);
                updateDataIcon(PhoneConstants.GEMINI_SIM_2);
                refreshViews(PhoneConstants.GEMINI_SIM_2);
                refreshViews(PhoneConstants.GEMINI_SIM_1);
            }
        ...
        if (!isCdma(slotId)) {
            ...
            if (tempSimState == IccCardConstants.State.READY || tempSimState == IccCardConstants.State.UNKNOWN) {
                if (FeatureOption.MTK_DT_SUPPORT) {
                    ...
                    try {
                        callState1 = iTelephony.getCallStateGemini(PhoneConstants.GEMINI_SIM_1);
                        callState2 = iTelephony.getCallStateGemini(PhoneConstants.GEMINI_SIM_2);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    if (!(tempNetType3G == NetworkType.Type_3G)) {
                        ...
                        if (telephony != null) {
                            try {
                                if (telephony.get3GCapabilitySIM() == PhoneConstants.GEMINI_SIM_2) {
        ...
        if (mAirplaneMode &&
            ...
            if (!mIsScreenLarge) {
                ...
                if (mHasMobileDataFeature) {
                    ...
                    if ((slotId == PhoneConstants.GEMINI_SIM_2) && mDataConnected) {
                    ...
                    } else if ((slotId == PhoneConstants.GEMINI_SIM_1) && mDataConnectedGemini) {
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        pw.println(hasService(PhoneConstants.GEMINI_SIM_1));
        pw.print("  hasService(2)=");
        pw.println(hasService(PhoneConstants.GEMINI_SIM_2));
    ...
    PhoneStateListener mPhoneStateListenerGemini = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState state) {
            ...
            //BEGIN [20120301][ALPS00245624]
            TelephonyManager telephonyManager = TelephonyManager.getDefault();
            mDataNetTypeGemini = telephonyManager.getNetworkTypeGemini(PhoneConstants.GEMINI_SIM_2);
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            Xlog.d(TAG, "PhoneStateListener:onCallStateChanged, state=" + state);
            // In cdma, if a voice call is made, RSSI should switch to 1x.
            if (isCdma(PhoneConstants.GEMINI_SIM_2)) {
                updateDataNetType(PhoneConstants.GEMINI_SIM_2);
                updateTelephonySignalStrength(PhoneConstants.GEMINI_SIM_2);
                refreshViews(PhoneConstants.GEMINI_SIM_2);
            }
    ...
    */
    ...
    private void updateOperatorInfo() {
        ...
        boolean sim1Inserted = isSimInserted(PhoneConstants.GEMINI_SIM_1);
        boolean sim2Inserted = isSimInserted(PhoneConstants.GEMINI_SIM_2);
