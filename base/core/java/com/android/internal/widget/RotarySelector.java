...
///LEWA BEGIN
         ...
         */
        public static final int RIGHT_HANDLE = 3;//2;
///LEWA END
...
///LEWA BEGIN
    ...
    public void setRevamped(boolean newState){
        if(newState){
            if(mCustomAppDimple)
                mBackground = getBitmapFor(com.lewa.internal.R.drawable.jog_dial_bg_rev_down);
            else
                mBackground = getBitmapFor(com.lewa.internal.R.drawable.jog_dial_bg_rev);
            mDimple = getBitmapFor(com.lewa.internal.R.drawable.jog_dial_dimple_rev);
            mDimpleDim = getBitmapFor(com.lewa.internal.R.drawable.jog_dial_dimple_dim_rev);
        }
    ...
    public void setLenseSquare(boolean newState){
        ...
        if(newState){
            mLenseMode=true;
            mBackground = getBitmapFor(com.lewa.internal.R.drawable.lense_square_bg);
        }
    }
///LEWA END
