...
///LEWA BEGIN
     ...
     * @hide
     */
    public static final String ACTION_APP_LAUNCH_FAILURE = "com.lewa.intent.action.APP_LAUNCH_FAILURE";

    /**
     * Broadcast Action: Request to reset the unrecoverable errors count to 0.
     * @hide
     */
    public static final String ACTION_APP_LAUNCH_FAILURE_RESET = "com.lewa.intent.action.APP_LAUNCH_FAILURE_RESET";

    /**
     * Woody Guo @ 2012/07/06
     *
     * Broadcast Action: Request to install the theme when it's added.
     * @hide
     */
    public static final String ACTION_THEME_FILE_ADDED = "com.lewa.intent.action.THEME_FILE_ADDED";

    /**
     * Broadcast Action: Request to update a theme.
     * @hide
     */
    public static final String ACTION_THEME_FILE_CHANGED = "com.lewa.intent.action.THEME_FILE_CHANGED";
///LEWA END
...
///LEWA BEGIN
    ...
    public static final String CATEGORY_THEME_PACKAGE_INSTALLED_STATE_CHANGE =
            "com.lewa.intent.category.THEME_PACKAGE_INSTALL_STATE_CHANGE";
///LEWA END
