...
///LEWA BEGIN
            if(!"com.lewa.permmanager".equals(uri.getHost()) && !lewa.content.PermissionHelper.checkPermission(mContext, getCallingPid(), getCallingUid(), getReadPermission(), uri))
                return new android.database.MatrixCursor(projection == null ? new String[]{"fake"} : projection, 1);
///LEWA END
