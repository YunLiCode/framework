...
///LEWA BEGIN
        if(Build.UNKNOWN.equalsIgnoreCase(Build.DefaultFontScale))
            fontScale = 1;
        else
            fontScale = Float.parseFloat(Build.DefaultFontScale);
///LEWA END
...
///LEWA BEGIN
        ...
        if (delta.fontChanged != 0 && fontChanged != delta.fontChanged) {
            fontChanged = delta.fontChanged;
...
///LEWA BEGIN
        result = 31 * result + (this.customTheme != null ? this.customTheme.hashCode() : 0);
///LEWA END
        return result;
    }
