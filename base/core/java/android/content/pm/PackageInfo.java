...
///LEWA BEGIN
     ...
     *
     */
    private boolean mDrmProtectedThemeApk = false;
...
///LEWA BEGIN
        ...
        dest.writeInt((mDrmProtectedThemeApk) ? 1 : 0);
...
///LEWA BEGIN
        ...
        mDrmProtectedThemeApk = (source.readInt() != 0);
