...
///LEWA BEGIN
    private static void bootCommand(Context context, String arg) throws IOException {
        // Woody Guo @ 2012/08/14
        // Bug 9734 may be caused by the absence of the /cache/recovery/ directory
        // because Java will create a file if it does not exist. But the directory
        // /cache/recovery/ should already have been created by calling 'RECOVERY_DIR.mkdirs()'.
        // Add debugging info to clear up this confusion
        Log.d(TAG, "recovery directory exists? " + RECOVERY_DIR.exists());
        Log.d(TAG, "command file exists? " + COMMAND_FILE.exists());
