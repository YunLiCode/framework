...
///LEWA BEGIN
    void applyNetworkRule(String command);
///LEWA END
    ...
    * WiFi Hotspot manager - USB Internet
    ...
    /**
    * WiFi Hotspot manager - Bandwidth throttle
     * @hide
     */
     void setInterfaceThrottleEnabled(boolean enable);
     
    /**
    * WiFi Hotspot manager - Bandwidth throttle
     * @hide
     */
     boolean getInterfaceThrottleEnabled();
