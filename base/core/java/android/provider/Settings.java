...
///LEWA BEGIN
        ...
        public static final long FAST_MODE_DEFAULT =
                lewa.os.Build.LEWA_DIAL_FASTMODE_SUPPORT ? FAST_MODE_ENABLE : FAST_MODE_DISABLE;
...
///LEWA END
         ...
         */
///LEWA BEGIN
        public static final int GPRS_CONNECTION_SETTING_DEFAULT = 1;//DEFAULT_SIM_NOT_SET_INT + 1;
///LEWA END
...
///LEWA END
         ...
         */
///LEWA BEGIN
        public static final int MOBILE_DATA_DEFAULT = 1;//(FeatureOption.MTK_DEFAULT_DATA_OFF || FeatureOption.MTK_GEMINI_SUPPORT) ? 0 : 1;        
///LEWA END
        ///LEWA BEGIN
...
///LEWA BEGIN
        /**
         * Whether assisted A-GPS should be enabled or not.
         * @hide
         */
        public static final String ASSISTED_A_GPS_ENABLED = "assisted_agps_enabled";
///LEWA END
        /**
