...
public class TimePicker extends FrameLayout {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        ///LEWA MODIFY BEGIN
        int layoutResourceId = Injector.getLayoutResourceId(context, attributesArray);
        ///LEWA MODIFY END
        ...
        // hour
        ///LEWA MODIFY BEGIN
        mHourSpinner =  Injector.getHourSpinner(context, this);
        ///LEWA MODIFY END
        ...
        // minute
        ///LEWA MODIFY BEGIN
        mMinuteSpinner = Injector.getMinuteSpinner(context, this);
        ///LEWA MODIFY END
        ...
        // am/pm
        ///LEWA MODIFY BEGIN
        View amPmView = Injector.getAmpmSpinner(context, this);
        ///LEWA MODIFY END
       ...
       ///LEWA ADD BEGIN
       setPosState(mHourSpinner);
       setPosState(mMinuteSpinner);
       setPosState(mAmPmSpinner);
       ///LEWA ADD END
    }
    ...
    static class Injector {
        static int getLayoutResourceId(Context context, TypedArray attributesArray) {
            if (LewaUiUtil.isV5Ui(context)) {
                return com.lewa.internal.R.layout.lewa_time_picker;
            } else {
                return attributesArray.getResourceId(
                        R.styleable.TimePicker_internalLayout, R.layout.time_picker);
            }
        }

        static NumberPicker getMinuteSpinner(Context context, View view) {
            if (LewaUiUtil.isV5Ui(context)) {
                return (NumberPicker)view.findViewById(com.lewa.internal.R.id.minute);
            } else {
                return (NumberPicker)view.findViewById(R.id.minute);
            }
        }

        static NumberPicker getHourSpinner(Context context, View view) {
            if (LewaUiUtil.isV5Ui(context)) {
                return (NumberPicker)view.findViewById(com.lewa.internal.R.id.hour);
            } else {
                return (NumberPicker)view.findViewById(R.id.hour);
            }
        }

        static View getAmpmSpinner(Context context, View view) {
            if (LewaUiUtil.isV5Ui(context)) {
                return view.findViewById(com.lewa.internal.R.id.amPm);
            } else {
                return view.findViewById(R.id.amPm);
            }
        }
    }

    @LewaHook(LewaHook.LewaHookType.NEW_METHOD)
    private void setPosState(android.widget.NumberPicker v){
