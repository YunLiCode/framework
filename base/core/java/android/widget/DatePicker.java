...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        ///LEWA MODIFY BEGIN
        int layoutResourceId = Injector.getLayoutResourceId(mContext, attributesArray);
        ///LEWA MODIFY END
        ...
        ///LEWA MODIFY BEGIN
        mSpinners = Injector.getSpinners(context, this);
        ///LEWA MODIFY END

        // calendar view day-picker
        ///LEWA MODIFY BEGIN
        mCalendarView = Injector.getCalendarView(context, this);
        ///LEWA MODIFY END
        ...
        // day
        ///LEWA MODIFY BEGIN
        mDaySpinner = Injector.getDaySpinner(context, this);
        ///LEWA MODIFY END
        ...
        // month
        ///LEWA MODIFY BEGIN
        mMonthSpinner = Injector.getMonthSpinner(context, this);
        ///LEWA MODIFY END
        ...
        // year
        ///LEWA MODIFY BEGIN
        mYearSpinner = Injector.getYearSpinner(context, this);
        ///LEWA MODIFY END
        ...
        for (int i = 0; i < spinnerCount; i++) {
            switch (order[i]) {
                case DateFormat.DATE:
                    ///LEWA ADD BEGIN
                    setPosState(mDaySpinner, i, spinnerCount);
                    ///LEWA ADD END
    ...
    static class Injector {
      static int getLayoutResourceId(Context context, TypedArray attributesArray) {
          if (LewaUiUtil.isV5Ui(context)) {
              return com.lewa.internal.R.layout.lewa_date_picker;
          } else {
              return attributesArray.getResourceId(R.styleable.DatePicker_internalLayout,
                      R.layout.date_picker);
          }
      }

      static NumberPicker getDaySpinner(Context context, View view) {
         if (LewaUiUtil.isV5Ui(context)) {
              return (NumberPicker)view.findViewById(com.lewa.internal.R.id.day);
          } else {
              return (NumberPicker)view.findViewById(R.id.day);
          }
      }

      static NumberPicker getMonthSpinner(Context context, View view) {
          if (LewaUiUtil.isV5Ui(context)) {
              return (NumberPicker)view.findViewById(com.lewa.internal.R.id.month);
          } else {
              return (NumberPicker)view.findViewById(R.id.month);
           }
      }

      static NumberPicker getYearSpinner(Context context, View view) {
          if (LewaUiUtil.isV5Ui(context)) {
              return (NumberPicker)view.findViewById(com.lewa.internal.R.id.year);
          } else {
              return (NumberPicker)view.findViewById(R.id.year);
           }
      }

      static LinearLayout getSpinners(Context context, View view) {
          if (LewaUiUtil.isV5Ui(context)) {
              return (LinearLayout)view.findViewById(com.lewa.internal.R.id.pickers);
          } else {
              return (LinearLayout)view.findViewById(R.id.pickers);
           }
      }

      static CalendarView getCalendarView(Context context, View view) {
          if (LewaUiUtil.isV5Ui(context)) {
              return (CalendarView)view.findViewById(com.lewa.internal.R.id.calendar_view);
          } else {
              return (CalendarView)view.findViewById(R.id.calendar_view);
           }
      }
    }
    ...
    private void resetShortMonths() {
        if(mCurrentLocale.getCountry().toUpperCase().equals("CN") && LewaUiUtil.isV5Ui(mContext)) {
    ...
    @LewaHook(LewaHook.LewaHookType.NEW_METHOD)
    private void setPosState(android.widget.NumberPicker v, int pos, int count)
    {
        if(v instanceof lewa.internal.v5.widget.NumberPicker)
        {
            lewa.internal.v5.widget.NumberPicker numberpicker = (lewa.internal.v5.widget.NumberPicker)v;
            numberpicker.setPositionState(1);
        }
    }
    ///LEWA ADD END
}
