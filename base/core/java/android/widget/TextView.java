...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    private boolean mEnableShowUrlDialog = false;
    ...
    private void setText(CharSequence text, BufferType type,
        ...
        CharSequence localCharSequence1 = mText;
        if (!text.equals(localCharSequence1)) {
            textChanged=true;
        } else {
            textChanged = false;
        }
    ...
    */
    ...
    public int viewportToContentHorizontalOffsetWrap() {
        return viewportToContentHorizontalOffset();
    }

    @LewaHook(LewaHook.LewaHookType.NEW_METHOD)
    public int viewportToContentVerticalOffsetWrap() {
       return viewportToContentVerticalOffset() ;
    }

    @LewaHook(LewaHook.LewaHookType.NEW_METHOD)
    public boolean canSelectTextWrap() {
...
//        }
    ...
    public void setCursorDrawableRes(int cursorDrawableRes) {
        ...
        for (int i = 0; i < mEditor.mCursorCount; i++) mEditor.mCursorDrawable[i] = null;
    ...
    @LewaHook(LewaHook.LewaHookType.NEW_METHOD)
    public boolean isInBatchEditModeWrap() {
        return isInBatchEditMode();
    }
    ...
    /**
     * M: Set browsering the url choice dialog or not. CR: ALPS00116591
     * @hide
    */
    public void setEnableShowUrlDialog(boolean enableShowUrlDialog) {
        mEnableShowUrlDialog = enableShowUrlDialog;
    }
    
    /**
     * M: Check browsering the url choice dialog or not. CR: ALPS00116591
     * @hide
    */
    public boolean isEnableShowUrlDialog() {
        return mEnableShowUrlDialog;
    }
