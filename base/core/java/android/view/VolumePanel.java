...
///LEWA BEGIN
        try {
            ...
            if(sc.streamType == AudioManager.STREAM_RING && muted){
                Class cls = Class.forName("lewa.util.LewaAudioManagerHelper");
                Object instance = cls.getConstructor(Context.class).newInstance(mContext);
                cls.getDeclaredMethod("setVibrationEnabled", new Class<?>[]{boolean.class})
                .invoke(instance, setVibrate);
            }
        }catch(Exception e){
