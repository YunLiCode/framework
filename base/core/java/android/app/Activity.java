...
public class Activity extends ContextThemeWrapper
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        if (!isChild()) {
            ...
            ///LEWA ADD BEGIN
            Injector.setContentViewForeground(this, mWindow);
            ///LEWA ADD END
        }
        mCalled = true;
    }
    ...
    static class Injector {        
        ...
        static void setContentViewForeground(Context context, Window window) {
            if (LewaUiUtil.isV5Ui(context)) {
                View contentView = window.getDecorView().findViewById(com.android.internal.R.id.content);
                if (contentView != null && contentView instanceof FrameLayout) {
                    Drawable drawable = LewaUiUtil.getDrawable(context, com.lewa.internal.R.attr.lewa_windowContentOverlay);
                    ((FrameLayout)contentView).setForeground(drawable);
                }
            }
        }
    }
