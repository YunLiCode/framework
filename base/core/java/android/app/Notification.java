...
///LEWA END
    ...
    //M: start
    /**
     * The flag indicating whether contentView want to handle touch event, 0 means no touch handle
     * needed, 1 means touch handle needed, default value is 0.
     */
    public int contentViewTouchHandle;
    ...
    public Notification(Parcel parcel)
    {
        ...
        //M: start
        contentViewTouchHandle = parcel.readInt();
...
///LEWA END
    ...
    public Notification clone() {
        ...
        //M: start
        that.contentViewTouchHandle = this.contentViewTouchHandle;
...
///LEWA BEGIN
    ...
    public void writeToParcel(Parcel parcel, int flags)
    {
        ...
        //M: start
        parcel.writeInt(contentViewTouchHandle);
