...
///LEWA BEGIN
    ...
    private static SoftReference<Handler> sHandler;
    ...
    public static Handler getHandler(){
        return sHandler == null ? null : sHandler.get();
    }
///LEWA END
    ...
    public Application() {
        super(null);
///LEWA BEGIN
        sApplication = new SoftReference<Application>(this);
        sHandler = new SoftReference<Handler>(new Handler());
///LEWA END
    }
