...
final class ApplicationPackageManager extends PackageManager {
    ...
    public PackageInfo getPackageInfo(String packageName, int flags)
        ...
        try {
            ...
            if (pi != null) {
///LEWA BEGIN
                //added by lewa zhanghui for umeng analytics ,
                if(packageName != null && ((!pi.isThemeApk && packageName.startsWith("com.lewa"))
                            || packageName.equals("com.android.systemui"))) {
                    pi.versionName = SystemProperties.get("ro.lewa.version");
                }
                //end 
///LEWA BEGIN
                return pi;
...
///LEWA BEGIN
    ...
    public List<PackageInfo> getInstalledThemePackages() {
        try {
            ...
            do {
                final String lastKey = lastItem != null ? lastItem.packageName : null;
                slice = mPM.getInstalledThemePackages(lastKey);
                lastItem = slice.populateList(packageInfos, PackageInfo.CREATOR);
            } while (!slice.isLastSlice());
            return packageInfos;
        } catch (RemoteException e) {
