        ...
        if (convertView == null) {
            convertView = onCreateView(parent);
             ...
             if (this instanceof PreferenceCategory) {
                 TypedArray a = getContext().obtainStyledAttributes(null, com.android.internal.R.styleable.View,
                         android.R.attr.listSeparatorTextViewStyle, 0);
                 final int N = a.getIndexCount();
                 int leftPadding = 0;
                 for (int i = 0; i < N; i++) {
                     int attr = a.getIndex(i);
                     if (attr == com.android.internal.R.styleable.View_paddingLeft) {
