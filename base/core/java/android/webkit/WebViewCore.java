    ...
    */
    ...
    private void setupViewport(boolean updateViewState) {
        ...
        if (mViewportUserScalable == false) {
            /// M: do not modify initial-scale if user-scalable is false. @{
            mViewportInitialScale = (mViewportInitialScale > 0) ? mViewportInitialScale : defaultScale;
            mViewportMinimumScale = (mViewportMinimumScale > 0) ? mViewportMinimumScale : defaultScale;
            mViewportMaximumScale = (mViewportMaximumScale > 0) ? mViewportMaximumScale : defaultScale;
            /// @}
        }
