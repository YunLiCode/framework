...
///LEWA BEGIN
    // Woody Guo @ 2012/07/06: Lewa theme
    // 2012/09/29: Change from 800 to 900 as it conflicts with FILE_TYPE_MP2PS
    public static final int FILE_TYPE_LEWA_THEME    = 900;
///LEWA END
...
///LEWA BEGIN
        // Woody Guo @ 2012/10/26: 3gp should not be recognized as audios
...
///LEWA END
        ...
        /// @}
///LEWA BEGIN
        addFileType("LWT", FILE_TYPE_LEWA_THEME, "application/lewa-theme");
///LEWA END
    }
