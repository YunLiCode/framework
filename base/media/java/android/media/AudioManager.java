...
public class AudioManager {
	...
	*@hide The audio stream for MATV */
     ...
     */
///LEWA BEGIN
    public static final int[] DEFAULT_STREAM_VOLUME = android.content.res.Resources.getSystem().getIntArray(com.android.internal.R.array.config_streamVolumeValues);
///LEWA END
    ...
    */
    ...
    public void setMode(int mode) {
        IAudioService service = getService();
///LEWA BEGIN
        if(!lewa.content.PermissionHelper.checkPermission(mContext, android.os.Process.myPid(), android.os.Process.myUid(), lewa.content.PermissionHelper.PERMISSION_MODIFY_AUDIO_SETTINGS))
            return;
///LEWA END
        try {
    ...
    public boolean isFmActive() {
     ...
     /**
     * M: Add for AudioProfile not change ringermode when adjust the volume.
     *
     * @param streamType The stream whose volume index should be set.
