...
///LEWA END    
     ...
     */
///LEWA BEGIN
    public static final int TYPE_ALL = TYPE_RINGTONE_2 | TYPE_RINGTONE | TYPE_NOTIFICATION | TYPE_ALARM;
///LEWA END
    // </attr>
...
///LEWA BEGIN
     ...
     * @hide
     */
    public static final String THEME_AUTHORITY = "com.lewa.thememanager.packageresources";
///LEWA END
...
///LEWA BEGIN
    public static final String KEY_DEFAULT_RINGTONE_2 = "mtk_audioprofile_default_ringtone_2";
///LEWA END
    /**
...
///LEWA BEGIN
    ...
    private Cursor getThemeRegularRingtones() {
        if ((mType & TYPE_RINGTONE) != 0) {
            return query(Uri.parse("content://com.lewa.thememanager.themes/themes"),
    ...
    private Cursor getThemeRegularRingtones1() {
        if ((mType & TYPE_RINGTONE_2) != 0) {
            return query(Uri.parse("content://com.lewa.thememanager.themes/themes"),
                    new String[] { "_id", "ringtone_name AS " + MEDIA_COLUMNS[1], "ringtone_uri_2",
                        "ringtone_name_key AS " + MEDIA_COLUMNS[3] },
                    getThemeWhereClause("ringtone_uri_2"), null, MEDIA_COLUMNS[3]);
        } else {
            return null;
        }
    }
...
///LEWA END
    ...
    /**
     * M: Returns a new {@link Cursor} of all the ringtones available. This method will always
    ...
    public static Uri getDefaultRingtoneUri(Context context, int type) {
        ...
        switch (type) {
            case TYPE_RINGTONE:
                ...
                break;
///LEWA BEGIN
            case TYPE_RINGTONE_2:
                uriString = Settings.System.getString(resolver, KEY_DEFAULT_RINGTONE_2);
                break;
///LEWA END                
            case TYPE_NOTIFICATION:
    ...
    /**
     * M: Check the given uri whether exist in device.
     * 
