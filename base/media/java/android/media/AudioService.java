...
public class AudioService extends IAudioService.Stub implements OnFinished {
    ...
    private static final int MSG_PERSIST_VIBRATE_SETTING = 28;
...
///LEWA BEGIN
            /*mVibrateSetting = getValueForVibrateSetting(0,
                                        ...
                                        mHasVibrator ? AudioManager.VIBRATE_SETTING_ON
...
///LEWA BEGIN
        sendMsg(mAudioHandler, MSG_PERSIST_VIBRATE_SETTING, SENDMSG_NOOP, 0, 0, null, 0);
///LEWA END
