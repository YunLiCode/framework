...
///LEWA BEGIN
                            if(mKeyguardViewManager.isLewaLockscreen()){
                                Bundle options = new Bundle();
                                options.putBoolean(KeyguardViewMediator.RESET_LEWALOCKSCREEN, true);
                                resetStateLocked(options);
                            }else{
                                resetStateLocked(null);
                            }
...
///LEWA BEGIN
                ...
                Settings.System.putInt(mContext.getContentResolver(), Settings.System.LOCKSCREEN_CHANGED, 3);
            }
///LEWA END
            /// @}
        }
...
///LEWA BEGIN
    public static final String RESET_LEWALOCKSCREEN="reset_lewalockscreen";
///LEWA END
    /// @}
