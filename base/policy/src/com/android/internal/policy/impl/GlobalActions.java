...
///LEWA BEGIN
        if (mDialog != null && (mUiContext == null || mKeyguardShowing != keyguardShowing)) {
///LEWA END
            mDialog.dismiss();
            mDialog = null;
...
///LEWA END
    ...
    private AlertDialog createDialog() {
        ...
        mAirplaneModeOn = new ToggleAction(
                com.lewa.internal.R.drawable.ic_lock_airplane_mode,
                com.lewa.internal.R.drawable.ic_lock_airplane_mode_off,
                R.string.global_actions_toggle_airplane_mode,
///LEWA BEGIN
                0 /* R.string.global_actions_airplane_mode_on_status */,
                0 /* R.string.global_actions_airplane_mode_off_status */) {
///LEWA END
        ...
        mItems.add(
            new SinglePressAction(
                    com.lewa.internal.R.drawable.ic_lock_shutdown,
...
///LEWA BEGIN
        // next: reboot
        mItems.add(
            new SinglePressAction(com.lewa.internal.R.drawable.ic_lock_reboot, com.lewa.internal.R.string.global_action_reboot) {
                public void onPress() {
...
///LEWA BEGIN
        ...
        mItems.add(
            new SinglePressAction(
                    com.lewa.internal.R.drawable.ic_lock_screenshot
                    , com.lewa.internal.R.string.global_action_screenshot) {
                public void onPress() {
                    takeScreenshot();
                }
...
///LEWA BEGIN
        ...
        final AlertDialog.Builder ab = new AlertDialog.Builder(getUiContext(), AlertDialog.THEME_HOLO_LIGHT);
...
///LEWA BEGIN
        protected SinglePressAction(int iconResId, int messageResId, int statusResId) {
            mIconResId = iconResId;
            mMessageResId = messageResId;
            mMessage = null;
...
///LEWA BEGIN
            if (0 != mStatusResId) {
                ((TextView) v.findViewById(R.id.status)).setText(mStatusResId);
            } else {
...
///LEWA BEGIN
            if (statusView != null) {
                if (mEnabledStatusMessageResId > 0 && mDisabledStatusMessageResId > 0) {
...
///LEWA END
    ...
    private class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            ...
            super(com.lewa.internal.R.drawable.ic_lock_silent_mode_on,
                    com.lewa.internal.R.drawable.ic_lock_silent_mode_off,
                    com.lewa.internal.R.string.global_action_toggle_silent_mode,
                    0,
                    0);
            ///LEWA END
        }
