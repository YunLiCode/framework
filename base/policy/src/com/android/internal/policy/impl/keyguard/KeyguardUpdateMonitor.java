...
///LEWA BEGIN
    private void handleSIMCardChanged() {
        ...
        */
        ...
        if(simList.size() == 2) {
            long fast_mode = Settings.System.getLong(mContext.getContentResolver(),
                    Settings.System.FAST_MODE_SWITCH_SETTING, Settings.System.FAST_MODE_DEFAULT);
            Settings.System.putLong(mContext.getContentResolver(),
                    Settings.System.FIRST_BOOT_FAST_MODE_SWITCH_SETTING, fast_mode);
            Intent it = new Intent();
            if (true) { //(fast_mode == Settings.System.FAST_MODE_ENABLE){
                it.setClassName("com.android.settings",
                    "com.mediatek.gemini.SimSettingGuide");
            }else{
                it.setClassName("com.android.settings",
                    "com.mediatek.gemini.SimSettingGprsChooseActivity");
            }
            ...
            if (simInfo.mSimId > 0) {
                Settings.System.putLong(mContext.getContentResolver(), Settings.System.GPRS_CONNECTION_SIM_SETTING, simInfo.mSimId);        
            }
        }
...
///LEWA END
    ...
    public boolean isPluggedIn() {
        return mBatteryStatus.isPluggedIn();
    }
