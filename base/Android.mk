...
##LEWA BEGIN
lewa-res-source-path := APPS/lewa-res_intermediates/src
##LEWA END
# the library
# ============================================================
include $(CLEAR_VARS)
...
##LEWA BEGIN
# Build and FileUtilities are built into framework.jar
LOCAL_SRC_FILES += $(call all-java-files-under, ../../vendor/lewa/frameworks/base/core/java/ext/)
##LEWA END
...
##LEWA BEGIN
LOCAL_SRC_FILES += core/java/com/android/internal/app/IAssetRedirectionManager.aidl \
    ../../vendor/lewa/frameworks/base/core/java/ext/lewa/util/IIconManager.aidl
##LEWA END
LOCAL_SRC_FILES += \
...
##LEWA BEGIN
LOCAL_INTERMEDIATE_SOURCES += \
    $(lewa-res-source-path)/com/lewa/internal/R.java \
    $(lewa-res-source-path)/lewa/R.java \
    # $(lewa-res-source-path)/lewa/Manifest.java
##LEWA END
...
ifeq ($(strip $(BT_UT)),yes)
   LOCAL_EMMA_COVERAGE_FILTER := +android.server.BluetoothA2dpService
...
##LEWA BEGIN
lewa_res_R_stamp := $(call intermediates-dir-for,APPS,lewa-res,,COMMON)/src/R.stamp
$(full_classes_compiled_jar): $(framework_res_R_stamp) $(mediatek_res_R_stamp) $(lewa_res_R_stamp)
...
##LEWA BEGIN
framework_built += $(call java-lib-deps,lewa-framework)
##LEWA END
...
LOCAL_SRC_FILES += \
	...
	core/java/android/view/IWindowManager.aidl \
	core/java/android/view/IWindowSession.aidl \
	../../mediatek/frameworks-ext/base/core/java/android/app/ISearchEngineManager.aidl
...
##LEWA BEGIN
include vendor/lewa/config/LeWa_framework.mk
##LEWA END
