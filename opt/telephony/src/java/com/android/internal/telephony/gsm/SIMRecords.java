                ...
                if (!FeatureOption.MTK_GEMINI_SUPPORT) {
                    ...
                    if (!isSimInfoReady || msg.what == EVENT_QUERY_ICCID_DONE_FOR_HOT_SWAP) {
                        ...
                        if(enCryState == null || "".equals(enCryState) || "trigger_restart_framework".equals(enCryState)) {
                            DefaultSIMSettings.onAllIccidQueryComplete(mContext, mPhone, iccid, null, false);
                        }
                    } else {
    ...
    public void setDefaultNameForNewSIM(String strName){
        ...
        if (simInfo!= null) {
            ...
            if (simDisplayName == null || 
                ...
                SIMInfo.setDefaultNameEx(mContext,simInfo.mSimId, strName, nameSource);
...
*/
    ...
    */
    ...
    public void setPhbReady(boolean isReady) {
        ...
        if (PhoneConstants.GEMINI_SIM_2 == mParentApp.getMySimId()) {
            SystemProperties.set(PROPERTY_RIL_PHB_READY_2, strPhbReady);
        } else {
            SystemProperties.set(PROPERTY_RIL_PHB_READY, strPhbReady);
        }   
    }
}
