...
public class GSMPhone extends PhoneBase {
    ...
    public static final String CFU_KEY = "cfu_query_key";   
    ...
    public void handleMessage (Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_REGISTERED_TO_NETWORK:
                ...
                if (needQueryCfu) {
                    int cfuSetting = Settings.Secure.getInt(getContext().getContentResolver(), CFU_KEY, -1);
                    LOGD("[GSMPhone] CFU_KEY = " + cfuSetting);
                    if (cfuSetting != -1) {
  ...
  /*      if (nState == SIM_INDICATOR_LOCKED){
    ...
    public boolean isSimInsert() {
        ...
        if (getMySimId() == PhoneConstants.GEMINI_SIM_1){
            mIccId = SystemProperties.get(PROPERTY_ICCID_SIM1);
        } else {
            mIccId = SystemProperties.get(PROPERTY_ICCID_SIM2);
        }
