                        ...
                        if (MEMORY_SIZE_IS_LARGE){
                            ...
                            if(getVideoCapability(VIDEO_ENCODER_MPEG_4_SP, &u4Width, &u4Height, &u4BitRate, &u4FrameRate ) > 0){
                                if((u4Width >= 1920) && (u4Height >= 1088)){
                                    videoCodec = new MediaProfiles::VideoCodec(VIDEO_ENCODER_MPEG_4_SP, 24000*1000/CamMode, 1920, 1088, 30/CamMode);
                                }
                                else{
                            ...
                            #endif
                            {
                                ...
                                videoCodec = new MediaProfiles::VideoCodec(VIDEO_ENCODER_MPEG_4_SP, 24000*1000/CamMode, 1920, 1080, 30/CamMode);
                            }
                        }
                        else{
